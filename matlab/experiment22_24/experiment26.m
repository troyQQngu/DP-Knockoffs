% experiment 26: we are testing the performance of JLT and AG under
% high-dimensional settings

list_len = 18;

% parameters
mu_list = 1; % magnitude of signals
p_list = 30000; % parameter size
n_list = floor(linspace(30000,200000,list_len)); % sample size
r_list = 10000; % rotation dimension
c0 = 0.001; % sparsity coefficient
