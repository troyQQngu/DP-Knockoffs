...
exp <- seq(2,3.5,length.out = r_iter)
n = as.integer(10^(5))

for (i in 1:r_iter) {
  r <- as.integer(10^exp[i])
  result <- experiment5(n,r)
  fdrs[i] = result$fdr
...
png("experiment_5_n_1e5.5_plot.png")

plot(sample_size,fdrs,
     main = "Projected Sample Size vs FDR & Power at n=10^5.5",
     xlim = xrange,
     ylim = yrange,
     xlab = "log10(r)",
     ylab = "",
...
powers_ne5_5 = powers
fdrs_ne5_5 = fdrs
save(powers_ne5_5, file = "powers_ne5_5.rda")
save(fdrs_ne5_5, file = "fdrs_ne5_5.rda")
